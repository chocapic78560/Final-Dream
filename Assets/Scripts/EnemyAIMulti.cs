    ...
    */
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.CompareTag("Player"))
        {
            ...
            {
                Debug.Log("attackCoroutine avant RepeatAttack = " + attackCoroutine);
    ...
    {
        if (collision.CompareTag("Player") && collision.gameObject == currentTarget && attackCoroutine != null)
        {
    ...
    {
        Debug.Log("début de RepeatAttack, attackCoroutine = " + attackCoroutine);
